      ...
      */}
      <Room name={roomName} password={roomPassword}>
        {({ room, peers, localMedia, remoteMedia }) => {
          ...
          return (
            <StyledUIContainer className="page">
              <StyledToolbar>
              ...
              <div className="mainContentLayout">
                ...
                <div className="chatScreen">
                    <ChatList
                    maxGroupDuration={3600}
                      room={room.address}
                      className={StyledChatListContainer}
                      renderGroup={({ chats, peer }) => (
                        <StyledMessageGroup key={chats[0].id}>
                          <StyledMessageMetadata>
                            <StyledDisplayName>{peer.displayName ? peer.displayName : 'Mehul'}</StyledDisplayName>{' '}
...
export default compose(withApollo,withRouter)(StudyRoom);
